<template>
    <div style="background: #F8F9FD; height: 100vh;">
        ...
        <div class="whoCurrentUser">
            <p class="currentUser">{{ PersonalData.last_name }}
                {{ PersonalData.first_name }}</p>
        </div>
        <hr>
        <div class="container">
            <b-card no-body>
                <b-tabs pills card vertical nav-wrapper-class="w-25">
                    <b-tab title="Аккаунт" active style="height: 70vh !important">
                        <b-card-text>
                            ...
                            <div class='bg'>
                                <input class='textarea' id='input-filter-staff1' name='Pwd' :value="PersonalData.email"
                                ...
                                <div class="col-md-4">
                                    <div class='bg'>
                                        <input class='textarea' id='input-filter-staff1' name='Pwd'
                                            :value="PersonalData.last_name" style="width: 100%; background: white;"
                                            readonly />
                                        <br>
                                        <label for='input-filter-staff1' class='label'
                                            style="margin-left: 20% !important; background: white;">Фамилия</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class='bg'>
                                        <input class='textarea' id='input-filter-staff1' name='Pwd'
                                            :value="PersonalData.first_name" style="width: 100%; background: white;"
                                            readonly />
                                        <br>
                                        <label for='input-filter-staff1' class='label'
                                            style="margin-left: 20% !important; background: white;">Имя</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class='bg'>
                                        <input class='textarea' id='input-filter-staff1' name='Pwd'
                                            :value="PersonalData.middle_name" style="width: 100%; background: white;"
                                            readonly />
                                        <br>
                                        <label for='input-filter-staff1' class='label'
                                            style="margin-left: 20% !important; background: white;">Отчество</label>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class='bg' style="background: white !important; float: left;">
                                    <input class='textarea' id='input-filter-staff2' name='Pwd'
                                        :value="getGroupName(personal)" style="background: white;" readonly
                                        v-for="personal in PersonalData.groups" :key="personal.id" />
                                    <br>
                                    <label for='input-filter-staff2' class='label'
                                        style="background: white;">Отдел</label>
                                    <br><br>
                                    <input class='textarea' id='input-filter-staff3' name='Pwd'
                                        :value="PersonalData.post" style="background: white;" readonly />
                                    <br>
                                    <label for='input-filter-staff3' class='label'
                                        style="background: white;">Должность</label>
                                </div>
                            </div>
        ...
        <!-- <div class="userField">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 userField3">
                        <b-card no-body>
                            <b-tabs pills card vertical>
                                <b-tab title="Аккаунт" active>
                                    <b-card-text>Аккаунт</b-card-text>
                                </b-tab>
                                <b-tab title="Сотрудники">
                                    <b-card-text>Сотрудники</b-card-text>
                                </b-tab>
                               
                            </b-tabs>
                        </b-card>
                    </div>
                    <div class="col-md-8 userField9 ml-5">
                        <div class="userField9-description">
                            <p class="userField9-description-text">Данные пользователя</p>
                        </div>
                        <hr style="width: 100% !important; margin: 0; padding:0;">
        ...
        <!-- <div class="contact-information">
            ...
            <br>
            <p class="contact-var"> <span class="contact-header">ФИО: </span>{{ PersonalData.last_name }}
                {{ PersonalData.first_name }} {{ PersonalData.middle_name }}</p>
            ...
            <p class="contact-var" v-for="personal in PersonalData.groups" :key="personal.id">
                <span class="contact-header" style="font-weight: 500; font-size: 15px;">Отдел:
                    {{ getGroupName(personal) }}</span>
            </p>
