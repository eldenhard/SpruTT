      ...
      <div class="table-content" v-show="visible">
        ...
        <label for="tenant"
          ...
          <input
            ...
            id="tenant"
            class="textarea mini"
            v-model="filter_arendaData.client"
          />
        </label>
        ...
        <label for="tenant" style="margin-left: 5px"
          ...
          <select
            ...
            class="mini"
            style="width: 100%"
            v-model="filter_arendaData.wagon_type"
          >
          ...
          <tbody>
            ...
            <td @click="open_modal(item.id)" class="delete">{{ index+1 }}</td>
              ...
              <td>
                <div class="inputcontainer">
                  <input
                    :id="`agreement_date` + item.id"
                    type="date"
                    v-model="item.agreement_date"
                    v-on:keyup.enter="
                  ...
                  <div
                    class="icon-container"
                    :id="`agreement_date_load` + item.id"
                    style="display: none"
                  >
                    <i class="loader"></i>
                  </div>
...
<td>
                <div class="inputcontainer">
                  <input
                    :id="`standard_loading` + item.id"
                    v-model="item.standard_loading"
                    type="number"
                  ...
                  <div
                    class="icon-container"
                    :id="`standard_loading_load` + item.id"
                    style="display: none"
                  >
                    <i class="loader"></i>
                  </div>
...
<td>
                <div class="inputcontainer">
                  <input
                    :id="`penalty_unloading` + item.id"
                    v-model="item.penalty_unloading"
                    type="number"
                  ...
                  <div
                    class="icon-container"
                    :id="`penalty_unloading_load` + item.id"
                    style="display: none"
                  >
                    <i class="loader"></i>
                  </div>
...
<!-- ШТРАФ ПОГРУЗКА -->
              <td>
                <div class="inputcontainer">
                  <input
                    :id="`penalty_loading` + item.id"
                    v-model="item.penalty_loading"
                    type="number"
                  ...
                  <div
                    class="icon-container"
                    :id="`penalty_loading_load` + item.id"
                    style="display: none"
                  >
                    <i class="loader"></i>
                  </div>
...
<!-- ТИП ВАГОНА -->
              <td>
                ...
                <select  :id="`wagon_type` + item.id" class="mini" style="height: 50% !important; border: none;"
                    v-model="item.wagon_type"
                    @change="submitData(item.wagon_type, item.id, 'wagon_type', 'wagon_type_load')">
                    <option value="Полувагон">ПВ</option>
                    <option value="Цистерна">ЦС</option>

                </select>
                  <!-- <input
                    :id="`wagon_type` + item.id"
                    v-model="item.wagon_type"
                    v-on:keyup.enter="submitData(item.wagon_type, item.id, 'wagon_type', 'wagon_type_load')"
                  /> -->
                  <div
                    class="icon-container"
                    :id="`wagon_type_load` + item.id"
                    style="display: none"
                  >
                    <i class="loader"></i>
                  </div>
