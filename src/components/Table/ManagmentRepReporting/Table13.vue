                ...
                "Собственный парк": {
                    ...
                    "Клиент 1": {
                        ...
                        "Станция погрузки 1": {
                            ...
                            "Вагоно-сутки": 254,
                            "МД ": 254,
                            "Доходность, руб./сут.": 254,
                            "Удельный МД, руб./ тн.": 254,
...
mounted() {
    // this.OpenChildren(document.getElementById('FuckingData13'), this.data)
},
methods: {
    Translate(val) {
        switch (val) {
    ...
    Actioned() {
        document.getElementById('FuckingData13').innerHTML = ""
        this.OpenChildren(document.getElementById('FuckingData13'), this.data)
