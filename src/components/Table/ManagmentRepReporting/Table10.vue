...
export default {
                    ...
                    "Станция 1": {
                        ...
                        'Станция_Возврата': {
                            "Продукт": {
                                ...
                                "Вагоно-сутки ": 254,
                                "МД": 254,
                                "Доходность, руб. / сутки": 254,
                                " Доходность (без уче-та подготовки)": 254,
                            },
                        }
    ...
    methods: {
        ...
        Actioned() {
            document.getElementById('FuckingData10').innerHTML = ""
            ...
            //             this.OpenChildren(document.getElementById('FuckingData10'), this.data3123)
