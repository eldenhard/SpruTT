            ...
            <table class="table table-sm table-bordered"  style="table-layout: fixed;" >
                ...
                <tbody>
                    <tr v-for="(finance) in financeDirecory" :key="finance.id">
                        ...
                        <td style="font-size: 15px; text-align: center;">{{ new Date(finance.created_at).toLocaleString() }}</td>
                        ...
                        <td v-else>Нет</td>
                        <td v-if="finance.scan != null"><a :href="finance.scan" target="_blank"><img
                                    style="height: 20px" src="@/assets/pdf.png" alt="скан"></a></td>
                        <td v-else>—</td>
                        <td>{{ finance.category }}</td>
                        <td>{{ finance.comment }}</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.work_name }}</td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.short_name }}
                        </td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.full_name }}</td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.els }}</td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.ogrn }}</td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.inn }}</td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.kpp }}</td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null">{{ finance.counterparty.legal_address }}
                        </td>
                        <td v-else>—</td>

                        <td v-if="finance.counterparty != null" style="font-size: 15px; text-align: center;">{{ new
                        ...
                        <td v-if="finance.counterparty != null">{{ finance.counterparty.phone }}</td>
                        <td v-else>—</td>
